...
export {
  ...
  type ErrorNoHelloData,
  type ErrorNoHelloMessage,
  type ErrorBadRoomCodeData,
  type ErrorBadRoomCodeMessage,
  type ErrorRoomFullData,
  type ErrorRoomFullMessage,
  type PlayerLeftData,
