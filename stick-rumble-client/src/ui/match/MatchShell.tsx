...
import { PhaserGame } from '../common/PhaserGame'
import { MatchEndScreen } from './MatchEndScreen'
import { DebugNetworkPanel } from '../debug/DebugNetworkPanel'
...
import { useStageMode } from '../common/mobileMode'
import {
...
import { RotateDeviceGate } from '../mobile/RotateDeviceGate'
...
export function MatchShell({ sessionToken, isAuthed, onExitToLobby }: MatchShellProps) {
